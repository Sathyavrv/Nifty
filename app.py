...
def get_recent_data(ticker):
    ...
    start_date = (datetime.today() - pd.DateOffset(days=5)).strftime('%Y-%m-%d')
...
volume_1 = st.sidebar.number_input('Volume_1', value=5000)
volume_2 = st.sidebar.number_input('Volume_2', value=5000)
